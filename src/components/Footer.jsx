...
const Footer = () => {
    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          <img src={assets.brand_image} alt="" />
          <p className='text-gray-400 mt-4'>"Looking to buy, sell, or rent your next property? TrustBrick is here to guide you every step of the way. Whether you're searching for your dream home or listing your property for the best value, our team is ready to assist. Reach out now and let’s build your future, one brick at a time.</p>
        </div>
 ...
 <button className='py-2 px-4 rounded bg-blue-500 text-white'>Subscribe</button>
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copyright 2024 @Himanshi. All Right Reserved.
      </div>
</div>
)
}
